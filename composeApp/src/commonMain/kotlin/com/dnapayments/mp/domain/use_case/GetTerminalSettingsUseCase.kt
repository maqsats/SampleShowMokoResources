...
import com.dnapayments.mp.data.model.stores.Setting
...
import com.dnapayments.mp.domain.model.payment_methods.setting.PaymentMethodType.APPLE_PAY
import com.dnapayments.mp.domain.model.payment_methods.setting.PaymentMethodType.GOOGLE_PAY
import com.dnapayments.mp.domain.model.payment_methods.setting.PaymentMethodType.KLARNA
import com.dnapayments.mp.domain.model.payment_methods.setting.PaymentMethodType.OPEN_BANK
import com.dnapayments.mp.domain.model.payment_methods.setting.PaymentMethodType.PAY_BY_BANK
import com.dnapayments.mp.domain.model.payment_methods.setting.PaymentMethodType.PAY_PALL
...
fun Setting?.isAvailable(): Boolean {
    if (this == null)
        return false
    return status != com.dnapayments.mp.domain.model.payment_methods.setting.SettingStatus.UNAVAILABLE.status
}

fun Setting?.isActive(): Boolean {
    if (this == null)
        return false
    return status == com.dnapayments.mp.domain.model.payment_methods.setting.SettingStatus.ACTIVE.status
}
