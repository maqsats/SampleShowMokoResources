package com.dna.payments.kmm.utils.date_picker.wheel_picker
...
fun InfiniteWheelViewImpl(
    ...
    content: @Composable LazyItemScope.(index: Int, textSize: Int) -> Unit,
) {
        ...
        LazyColumn(
            ...
            items(if (isEndless) Int.MAX_VALUE else count) {
                ...
                Box(
                    ...
                    if (isEndless) {
                        content(it % itemCount, rotateDegree.toInt())
                    } else if (it >= rowOffsetCount && it < itemCount + rowOffsetCount) {
                        content((it - rowOffsetCount) % itemCount, rotateDegree.toInt())
                    }
                }
